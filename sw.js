...
// غيّرنا اسم الكاش عشان النسخة الجديدة (بعد تغيير اسم التطبيق) تتحمّل فريش، بدل
// ما تفضل عالقة على نسخة قديمة مخزّنة باسم التطبيق القديم
const CACHE_NAME = 'khazinaty-v1';
